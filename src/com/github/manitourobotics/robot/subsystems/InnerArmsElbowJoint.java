 ...
 * @author robotics
 */
//public class InnerArmsElbowJoint extends PIDSubsystem {
public class InnerArmsElbowJoint extends Subsystem {
    ...
    Jaguar elbowArmsMotor = new Jaguar(RobotMap.PWM_INNER_ARMS_ELBOW_JOINT);
    ...
    public InnerArmsElbowJoint(boolean encoderEnabled) {
    ...
    public InnerArmsElbowJoint() {
        //super("InnerArmsElbowJoint", Kp, Ki, Kd);
